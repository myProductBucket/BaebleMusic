...
package com.baeble.www.baebleapp.tv.cards;
...
public class CharacterCardView extends BaseCardView {
    ...
    public CharacterCardView(Context context) {
        ...
        LayoutInflater.from(getContext()).inflate(R.layout.tv_character_card, this);
        setOnFocusChangeListener(new View.OnFocusChangeListener() {
            ...
            public void onFocusChange(View v, boolean hasFocus) {
                ...
                if (hasFocus) {
                    container.setBackgroundResource(R.drawable.tv_character_focused);
                    mainImage.setBackgroundResource(R.drawable.tv_character_focused);
                } else {
                    container.setBackgroundResource(R.drawable.tv_character_not_focused_padding);
                    mainImage.setBackgroundResource(R.drawable.tv_character_not_focused);
                }
            }
        });
        setFocusable(true);
